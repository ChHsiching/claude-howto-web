...
AGPL-3.0-only · Copyright (c) 2026 ChHsiching —— 见 [LICENSE](LICENSE) —— 适用于本仓库的站点脚手架与工具。使用（含公司内部使用）、修改、分发均免费；分发或以本代码提供网络服务时，衍生作品须以 AGPL-3.0 开源。闭源商用须另行获取商业授权：hsichingchang@gmail.com

内容来自 [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto)（MIT 许可证），沿用其上游协议。
